...
<?php $__env->startSection('makenews'); ?>
			...
			<div class="col-lg-8">
				<div class="card card-primary">
				  <div class="card-header">
					<h3 class="card-title">Create News Data</h3>
				  </div>
				  <!-- /.card-header -->
				  <!-- form start -->
				  <form action="<?php echo e(route('createnewdata')); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="card-body">
					  ...
					  <div class="form-group">
						...
						<textarea type="text" rows="4" class="form-control" name="summary"></textarea>
...
<?php echo $__env->make('accountpanel.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\laravels\portomediaberita\resources\views/accountpanel/berita/makenews.blade.php ENDPATH**/ ?>